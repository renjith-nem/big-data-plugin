...
public class WasbFileNameParser extends URLFileNameParser {

  public static final String EMPTY_HOSTNAME = "";

  private static final WasbFileNameParser INSTANCE = new WasbFileNameParser();

  private WasbFileNameParser() {
    super( -1 );
  }

  public static WasbFileNameParser getInstance() {
    return INSTANCE;
  }
