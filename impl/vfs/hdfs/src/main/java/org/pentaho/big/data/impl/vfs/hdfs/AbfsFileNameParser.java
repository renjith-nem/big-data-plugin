...
public class AbfsFileNameParser extends URLFileNameParser {

  public static final String EMPTY_HOSTNAME = "";

  private static final AbfsFileNameParser INSTANCE = new AbfsFileNameParser();

  private AbfsFileNameParser() {
    super( -1 );
  }

  public static AbfsFileNameParser getInstance() {
    return INSTANCE;
  }
